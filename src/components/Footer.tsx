    ...
    <footer className="bg-white text-slate-600 py-16 border-t border-slate-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            {subscribed ? (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="inline-flex items-center justify-center px-4 py-3 bg-slate-900 text-white hover:bg-brand-500 hover:text-slate-950 rounded-xl text-xs font-bold uppercase tracking-wider hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 hover:shadow-brand-500/20 focus:ring-4 focus:ring-brand-200 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:bg-slate-900 cursor-pointer shadow-sm"
                >
                  {isLoading ? (
                    <>
        ...
        <div className="mt-16 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex flex-wrap items-center space-x-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            <button
              type="button"
              onClick={openCookiePreferences}
              className="hover:text-brand-500 transition-colors uppercase tracking-widest cursor-pointer"
            >
              Cookie Settings
            </button>
            <Link
