...
export default function Clients() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <section className="stripe-gradient py-20 lg:py-28 border-b border-slate-200 text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            {"Trusted By".split(" ").map((word, index) => (
              <motion.span
                key={index}
                variants={{
      ...
      <CaseStudies caseStudies={strategyCaseStudies} />
      ...
      <CaseStudies caseStudies={lampCaseStudies} />
