...
const testimonialSets = [
  [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/avatars/sarah-chen.jpg`,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/avatars/michael-rodriguez.jpg`,
  ...
  [
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/avatars/emily-watson.jpg`,
    ...
    },
    {
      ...
      name: "David Kim",
      role: "COO, HealthPlus",
      image: `${import.meta.env.BASE_URL}images/avatars/david-kim.jpg`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-8">
            ...
            >
              <Link
                to="/resources"
                className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white border border-slate-200 rounded-full hover:border-brand-500 hover:shadow-sm transition-all"
              >
                <span className="w-2 h-2 bg-brand-500 rounded-full"></span>
                <span className="text-xs font-bold uppercase tracking-widest text-slate-600 hover:text-brand-600">
            ...
            >
              <Link
                to="/contact"
                className="bg-brand-500 text-slate-950 px-8 py-4 rounded-xl text-sm font-bold uppercase tracking-wider shadow-lg hover:bg-brand-400 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 inline-block shadow-brand-500/20"
              >
                Start Your Journey
              </Link>
              <Link
                to="/about"
                className="bg-white border border-slate-200 text-slate-900 px-8 py-4 rounded-xl text-sm font-bold uppercase tracking-wider hover:bg-slate-50 hover:border-slate-300 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 inline-block"
              >
                Our Methodology
              </Link>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-brand-50 text-brand-700 border border-brand-200 px-3.5 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase shadow-sm">
                <span>The Vision Barrier</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tight text-slate-900">
                Bridging the Gap
              </h2>
              <blockquote className="border-l-4 border-brand-500 pl-6 text-xl text-slate-600 italic leading-relaxed">
      ...
      <section className="bg-slate-50 py-20 lg:py-28 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-extrabold tracking-tight text-slate-900 mb-6 leading-[1.15]">
                ...
                <motion.div
                  ...
                  className={`group relative overflow-hidden bg-slate-900 border border-slate-200 rounded-3xl cursor-pointer transition-all duration-500 ease-in-out flex flex-col ${
                    isActive
                      ...
                      : "basis-auto md:basis-[10%] hover:border-brand-500/50"
                  }`}
                >
                    ...
                    {isActive && (
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="flex items-center gap-3 font-bold text-white group/btn w-fit hover:text-brand-300 transition-colors"
                        >
                          Explore Program
                          <span
