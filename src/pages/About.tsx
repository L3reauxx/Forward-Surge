...
export default function About() {
  return (
    <div className="bg-white">
      <section className="relative overflow-hidden stripe-gradient py-20 lg:py-28">
        <div className="absolute inset-0 bg-surge-pattern opacity-40"></div>
        <AnimatedBlob />
        <div className="absolute inset-0">
          <img 
            src={`${import.meta.env.BASE_URL}images/boardroom-meeting.jpg`} 
            alt="Forward Surge Leadership" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-white text-brand-700 border border-slate-200 px-3.5 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase mb-8 shadow-sm"
          >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-16 text-left">
            <motion.div 
              ...
              className="bg-white/80 backdrop-blur-md border border-slate-200 p-8 rounded-3xl shadow-xl shadow-slate-100"
            >
      ...
      <section className="py-20 lg:py-28 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white text-brand-700 border border-slate-200 px-3.5 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase mb-4 shadow-sm">
              <span>Principles</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-extrabold text-slate-900 mb-6 tracking-tight leading-[1.15]">Our Core Values</h2>
            <p className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed">The foundational pillars that guide our every interaction and strategic decision.</p>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-50 border border-brand-200 text-brand-700 group-hover:bg-brand-100 transition-colors mb-6 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              className="order-2 lg:order-1 relative aspect-square bg-slate-900 rounded-3xl p-12 flex flex-col justify-center overflow-hidden border border-slate-800 shadow-2xl"
            >
              ...
              <div className="relative z-10 space-y-12">
                <div className="text-center">
                  ...
                  <div className="text-brand-400 font-bold uppercase tracking-wider text-xs">Intellectual Learning</div>
                  <div className="text-slate-400 text-sm mt-2 font-medium">Creating Awareness</div>
                </div>
                
                <div className="text-center">
                  <div className="text-6xl font-display font-bold text-white mb-2">20%</div>
                  <div className="text-brand-400 font-bold uppercase tracking-wider text-xs">Adaptive Learning</div>
                  <div className="text-slate-400 text-sm mt-2 font-medium">Acceptance & Adaptation</div>
                </div>
                
                <div className="text-center">
                  <div className="text-8xl font-display font-bold text-white mb-2">70%</div>
                  <div className="text-brand-400 font-bold uppercase tracking-wider text-xs">Application</div>
                  <div className="text-slate-400 text-sm mt-2 font-medium">Learning by Doing via Coaching</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-brand-50 text-brand-700 border border-brand-200 px-3.5 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase shadow-sm">
                <span>The Framework</span>
              </div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-extrabold text-slate-900 leading-[1.15] tracking-tight">
              ...
              <div className="space-y-6 pt-4">
                <div className="flex space-x-4 items-start">
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-50 border border-brand-200 text-brand-700 flex items-center justify-center font-bold text-sm shadow-xs mt-0.5">1</div>
                  <div>
                    <h4 className="text-lg font-bold text-slate-900">Intellectual Learning (10%)</h4>
                    <p className="text-slate-600 mt-1 font-medium leading-relaxed">Creating awareness and introducing new concepts and frameworks.</p>
                  </div>
                </div>
                <div className="flex space-x-4 items-start">
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-50 border border-brand-200 text-brand-700 flex items-center justify-center font-bold text-sm shadow-xs mt-0.5">2</div>
                  <div>
                    <h4 className="text-lg font-bold text-slate-900">Adaptive Learning (20%)</h4>
                    <p className="text-slate-600 mt-1 font-medium leading-relaxed">Creating acceptance and shaping leaders on how to adapt training for the workplace.</p>
                  </div>
                </div>
                <div className="flex space-x-4 items-start">
                  <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-50 border border-brand-200 text-brand-700 flex items-center justify-center font-bold text-sm shadow-xs mt-0.5">3</div>
                  <div>
                    <h4 className="text-lg font-bold text-slate-900">Application (70%)</h4>
                    <p className="text-slate-600 mt-1 font-medium leading-relaxed">"Learning by doing." Real-time coaching that supports behavior change and addresses leadership growth areas.</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 lg:py-28 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-extrabold text-slate-900 mb-6 tracking-tight leading-[1.15]">Leadership & Board</h2>
            <p className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed">The experienced minds shaping the future of African enterprise.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {team.map((member, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl aspect-[4/5] bg-slate-900 shadow-xl border border-slate-200">
                  <img 
                    src={member.image} 
                    alt={member.name} 
                  ...
                  <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end z-10">
                    ...
                    <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out">
                      <div className="overflow-hidden min-h-0">
                        <p className="text-slate-300 leading-relaxed text-sm opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 ease-out delay-150 pt-2 font-medium">
                          {member.bio}
                        </p>
                      </div>
                    </div>
